...
OutputDir={#DistDir}
OutputBaseFilename=Helios-{#MyAppVersion}-windows-x64
Compression=lzma2
...
[Icons]
Name: "{autoprograms}\Helios"; Filename: "{app}\{#MyAppExeName}"
Name: "{autodesktop}\Helios"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "Create a desktop shortcut"; GroupDescription: "Additional icons:"; Flags: unchecked

[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Launch Helios"; Flags: nowait postinstall skipifsilent
